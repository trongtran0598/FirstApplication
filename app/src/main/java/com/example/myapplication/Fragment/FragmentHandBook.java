...
public class FragmentHandBook extends Fragment {
    ...
    public SendIntent2 sendIntent2;

    public interface SendIntent2 {
    ...
    public static FragmentHandBook newInstance() {

        Bundle args = new Bundle();

        FragmentHandBook fragment = new FragmentHandBook();
    ...
    public class FeedTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            ...
            urlLink = "https://lienminh.garena.vn/cam-nang?format=feed&type=rss";
        }
...
//                    img = description.substring(startIndex + 5, endIndex + 3);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if (context instanceof FragmentHandBook.SendIntent2) {
            sendIntent2 = (FragmentHandBook.SendIntent2) context;
        } else {
